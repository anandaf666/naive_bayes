<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
      <a class="sidebar-brand brand-logo" href="index.html">Admin Sistem Pakar</a>
    ...
    <ul class="nav">
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{url('show_penyakit')}}">
          <span class="menu-icon">
            <i class="mdi mdi-file-document-box"></i>
          </span>
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{url('show_gejala')}}">
          <span class="menu-icon">
            <i class="mdi mdi-file-document-box"></i>
          </span>
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{url('show_relasi')}}">
          <span class="menu-icon">
            <i class="mdi mdi-file-document-box"></i>
          </span>
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{url('show_solusi')}}">
          <span class="menu-icon">
            <i class="mdi mdi-file-document-box"></i>
          </span>
